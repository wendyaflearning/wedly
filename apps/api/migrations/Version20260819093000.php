...
final class Version20260819093000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_92396BDFCBBB0ED ON wedding_consent (wedding_id)');
        $this->addSql('ALTER TABLE wedding_consent ADD CONSTRAINT FK_92396BDFCBBB0ED FOREIGN KEY (wedding_id) REFERENCES wedding (id) ON DELETE CASCADE NOT DEFERRABLE');
    }
