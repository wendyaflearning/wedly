...
#[Route(
    '/api/v1/admin/tag-types/{id}/deactivate',
    name: 'api_admin_tag_type_deactivate',
    requirements: ['id' => '[0-9a-fA-F-]{36}'],
    methods: ['PATCH'],
)]
final readonly class DeactivateTagTypeAction
{
    public function __construct(private AdminTagTypeService $tagTypeService) {}

    public function __invoke(string $id): JsonResponse
    {
        $tagType = $this->tagTypeService->deactivate($id);
