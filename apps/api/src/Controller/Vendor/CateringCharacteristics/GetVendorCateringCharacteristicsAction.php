...
#[Route('/api/v1/vendors/{id}/catering-characteristics', name: 'api_vendor_catering_characteristics_get', methods: ['GET'])]
final class GetVendorCateringCharacteristicsAction extends AbstractController
{
