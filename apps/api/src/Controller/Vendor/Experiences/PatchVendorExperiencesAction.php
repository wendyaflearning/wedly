...
#[Route('/api/v1/vendors/{id}/experiences', name: 'api_vendor_experiences_patch', methods: ['PATCH'])]
final class PatchVendorExperiencesAction extends AbstractController
{
