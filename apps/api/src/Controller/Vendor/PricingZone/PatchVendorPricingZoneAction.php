...
#[Route('/api/v1/vendors/{id}/zone-pricing', name: 'api_vendor_zone_pricing_patch', methods: ['PATCH'])]
final class PatchVendorPricingZoneAction extends AbstractController
{
