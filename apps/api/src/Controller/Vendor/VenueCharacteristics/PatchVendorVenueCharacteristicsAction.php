...
#[Route('/api/v1/vendors/{id}/venue-characteristics', name: 'api_vendor_venue_characteristics_patch', methods: ['PATCH'])]
final class PatchVendorVenueCharacteristicsAction extends AbstractController
{
