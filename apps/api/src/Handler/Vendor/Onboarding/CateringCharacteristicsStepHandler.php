...
readonly class CateringCharacteristicsStepHandler extends AbstractOnboardingStepHandler
{
    ...
    public function handle(Vendor $vendor, array $data): void
    {
        ...
        /** @var CateringCharacteristicsRequestDto $dto */
        $dto = $this->validate(CateringCharacteristicsRequestDto::fromArray($data));
