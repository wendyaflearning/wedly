...
use App\DTO\Vendor\Step\CreatorProcessRequestDto;
...
readonly class CreatorProcessStepHandler extends AbstractOnboardingStepHandler
{
    ...
    {
        /** @var CreatorProcessRequestDto $dto */
        $dto = $this->validate(CreatorProcessRequestDto::fromArray($data));
