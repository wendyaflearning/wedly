...
use App\DTO\Vendor\Step\CreatorUniverseRequestDto;
...
readonly class CreatorUniverseStepHandler extends AbstractOnboardingStepHandler
{
    ...
    {
        /** @var CreatorUniverseRequestDto $dto */
        $dto = $this->validate(CreatorUniverseRequestDto::fromArray($data));
