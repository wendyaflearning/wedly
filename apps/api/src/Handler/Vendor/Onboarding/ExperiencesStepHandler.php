...
use App\DTO\Vendor\Step\ExperiencesRequestDto;
...
readonly class ExperiencesStepHandler extends AbstractOnboardingStepHandler
{
    ...
    {
        $dto = ExperiencesRequestDto::fromArray($data);
