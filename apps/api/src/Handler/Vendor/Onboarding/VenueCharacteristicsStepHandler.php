...
readonly class VenueCharacteristicsStepHandler extends AbstractOnboardingStepHandler
{
    ...
    public function handle(Vendor $vendor, array $data): void
    {
        ...
        /** @var VenueCharacteristicsRequestDto $dto */
        $dto = $this->validate(VenueCharacteristicsRequestDto::fromArray($data));
