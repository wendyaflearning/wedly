...
final class UpdateBioRequestDtoTest extends TestCase
{
    ...
    {
        $dto = new UpdateBioRequestDto(str_repeat('a', 301));
        $violations = $this->validator->validate($dto);
