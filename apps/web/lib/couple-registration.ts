...
/**
 * Everything the couple typed across screens 1 to 7, flattened the way
 * `POST /api/v1/register` reads it. The contact request travels as the vendor id
 * alone: the service label was only ever there to write the screen copy.
 */
...
export function buildRegistrationPayload(
  ...
  return {
    ...
    vendorId: data.contactRequest?.vendorId ?? null,
  }
}
