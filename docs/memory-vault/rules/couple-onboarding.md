...
- `apps/web/app/couple-onboarding/navigation.test.ts` (`canContinue`)
- `apps/api/tests/Unit/DTO/Couple/RegisterRequestDtoTest.php` (contraintes
...
(doublon d'email, consentement, lead)
- `apps/api/tests/Unit/DTO/Couple/RegisterRequestDtoTest.php` (mot de passe
